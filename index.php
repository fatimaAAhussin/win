...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
     ...
     <img src="images/perfume.jpg" style="border-radius: 50%; vertical-align: middle;width: 200px;height: 200px;" alt="" >
       <h1 class="display-4 fw-normal text-success">اربح مع عطور اف اي </h1>
       <p class="lead fw-normal">باقي على فتح التسجيل</p>
       <div id="demo"></div>
       <p class="lead fw-normal text-success">اشتري مجموعة من عطورنا وادخل السحب على الجائزة الكبرى</p>
       <a class="btn btn-outline-secondary" href="#">Coming soon</a>
     </div>
     <div class="container">
     <ul class="list-group">
      <li class="list-group-item list-group-item-success" aria-current="true">NEW PRODUCTS</li>
    ...
    <button type="button" id="winner" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">
اختار الرابح
</button>
</div>
    <!-- Modal -->
